#!/usr/bin/env bash
# =============================================================================
#  build-kong-3.9.2-arm64.sh
#  Build Kong OSS 3.9.2 arm64 .deb using QEMU emulation
#  OpenResty: 1.31.1.1   |   Base OS: Ubuntu 20.04
#
#  Prerequisites:
...
BUILD_TOOLS_DIR="/tmp/kong-build-tools-392-arm64"
KONG_SOURCE_DIR="/tmp/kong-source-392-arm64"
